...
file_data = open("/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/A_warddata.txt", "r", encoding="utf-8")
...
#cmd2 = 'scp /home/mcgm/Development/mcgm/mcgm/static/html2pdf/final-html/index2.pdf root@205.147.109.56:/home/ajit_cleanupmumbai_minorwork/Award_dashboard.pdf'
#cmd2 = 'scp /home/mcgm/Development/mcgm/mcgm/static/html2pdf/final-html/index2.pdf root@164.52.223.39:/home/cleanupmumbai_dashboard_mails/Award_dashboard.pdf'

#os.system(cmd2)



#f = open("/home/mcgm/Development/mcgm/mcgm/dashboard/generate_daily_dashboard_pdfs/sendadminreportflag.txt", "w")
#f.write(str(sendflag))
#f.close()



#cmd3 = 'scp /home/mcgm/Development/mcgm/mcgm/dashboard/generate_daily_dashboard_pdfs/sendadminreportflag.txt root@205.147.109.56:/home/ajit_cleanupmumbai_minorwork/sendadminreportflag.txt'
#os.system(cmd3)
