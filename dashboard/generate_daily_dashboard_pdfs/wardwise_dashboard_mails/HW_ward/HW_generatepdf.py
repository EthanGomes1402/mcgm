...
file_data = open("/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/HW_warddata.txt", "r", encoding="utf-8")    #CHANGE
...
cmd2 = 'scp /home/mcgm/Development/mcgm/mcgm/static/html2pdf/final-html/index2.pdf root@205.147.109.56:/home/ajit_cleanupmumbai_minorwork/wardwise_dashboard_mails/HW_ward/dashboard.pdf'
os.system(cmd2)



f = open("/home/mcgm/Development/mcgm/mcgm/dashboard/generate_daily_dashboard_pdfs/wardwise_dashboard_mails/HW_ward/sendadminreportflag.txt", "w")
f.write(str(sendflag))
f.close()



cmd3 = 'scp /home/mcgm/Development/mcgm/mcgm/dashboard/generate_daily_dashboard_pdfs/wardwise_dashboard_mails/HW_ward/sendadminreportflag.txt root@205.147.109.56:/home/ajit_cleanupmumbai_minorwork/wardwise_dashboard_mails/HW_ward/sendadminreportflag.txt'
os.system(cmd3)
time.sleep(1)