...
def latest_vehicle_status_v3(request):
    ...
    #vehicles  = list(map(lambda vehicle : Vehicle.objects.get(pk=vehicle) , form_data['selectVehicle'].split("_")))
        ...
        return render(request,'dashboard/latest_vehicle_status.html',{ 'all_online_entries' : resultdict['data']['online'],'all_offline_entries' : resultdict['data']['offline'] , 'scvcount' : '449', 'lccount' : '287', 'mccount' : '204', 'swcount' : '0', 'dwcount' : '38', 'wwcount': '30', 'othercount' : '39','totalvehiclecount' : '1047' })
