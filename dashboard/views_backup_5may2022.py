...
def latest_vehicle_status_v3(request):
    ...
    f = open("/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/ward_info.txt",'w')
    f.write(str(iward))
    f.close()

    filepath = "/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/ward_"+str(iward)+"_updatetimestamp.txt"
    ...
    if iward:
        ...
        return render(request,'dashboard/latest_vehicle_status.html',{ 'all_online_entries' : response_data['data']['online'],'all_offline_entries' : response_data['data']['offline']})
