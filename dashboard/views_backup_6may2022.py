...
def latest_vehicle_status_v3(request):
    ...
    if iward:
        ...
        timefilepath = "/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/ward_"+str(iward)+"_updatetimestamp.txt"
        ...
        file_data = open("/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/"+str(iward)+"_warddata.txt", "r", encoding="utf-8")
...
def create_response_data_for_warduser(iward):
    ...
    for each_th_record_dict in Current_tracklog_history.objects.values('vehicle').annotate(max_dt=Max('datetime')).order_by('max_dt'):
        ...
        #print(all_vth_record)
        #vehicles  = list(map(lambda vehicle : Vehicle.objects.get(pk=vehicle) , form_data['selectVehicle'].split("_")))
        writefilename = "/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/warddata_"+str(iward)+"_writing.txt"
        ...
        src = "/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/warddata_"+str(iward)+"_writing.txt"
        dst = "/home/mcgm/Development/mcgm/mcgm/dashboard/loaddatafast/"+str(iward)+"_warddata.txt"
        shutil.copyfile(src, dst)