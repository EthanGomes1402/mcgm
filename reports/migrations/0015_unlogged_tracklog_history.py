# Generated by Django 2.2.7 on 2022-01-20 02:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('reports', '0014_faulty_records'),
    ]

    operations = [
        migrations.CreateModel(
            name='Unlogged_tracklog_history',
            fields=[
                ...
                ('vehicle', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='unlogged_tracklog_historys', to='swmadmin.Vehicle')),
            ],
            options={
