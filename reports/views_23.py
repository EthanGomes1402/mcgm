...
def route_compliance(request):
    ...
    #print("Todate ", todate)    
        ...
        for row1 in fetch1:
            ...
            postgreSQL_select_Query2 = f"select longitude,latitude from swm.vehicle_tracklog_historys where vehicle_id = '{vehicle_id}' and datetime between '{fromdate}' and '{todate}' and shift = '{shift}' order by datetime asc;"
            ...
            compliance_result_yes_no_website_array.append(compliance_result_yes_no_website_array_2)
        ...
        trial_res['compliance_result_yes_no'].append(compliance_result_yes_no_website_array_2)
        ...
        for n in range(count):
          ...
          all_data['compliance_result_yes_no'] = compliance_result_yes_no_website_array_2[n]
          ...
          compliance_result_yes_no_website_array_2[n] = []
