...
def check_params(request, param):
    response_data=dict()
    response_data['status'] = 'success'
    response_data['data'] = list()
...
def weight_report(request):
    ...
    if request.method == 'POST':
        ...
        weight_query = "SELECT sendweighexitdata.vehicle_no,sendweighexitdata.weighbridge_ul, sendweighexitdata.trans_date_ul, sendweighexitdata.trans_time_ul, sendweighexitdata.act_shift_ul, sendweighexitdata.act_net_weight, sendweighexitdata.invehicle_image, sendweighexitdata.unladen_weight, sendweighentrydata.gross_weight FROM swm.sendweighexitdata JOIN swm.vehicles ON sendweighexitdata.vehicle_no = swm.vehicles.plate_number JOIN common_ward ON common_ward.id = swm.vehicles.ward_id JOIN swm.sendweighentrydata ON sendweighexitdata.vehicle_no = sendweighentrydata.vehicle_no WHERE common_ward.name = '"+iward+"' AND sendweighexitdata.trans_date_ul = '"+date+"' AND sendweighexitdata.act_shift_ul = '"+shift_str+"'"
