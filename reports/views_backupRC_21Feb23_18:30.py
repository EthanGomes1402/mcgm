...
def route_compliance(request):
    ...
    #print("Todate ", todate)    
        ...
        for row1 in fetch1:
            ...
            postgreSQL_select_Query3 = f"select distinct t2.route_code,t1.route_name from swm.route_allocation t1, swm.route_compliance t2 where t1.route_code <> '' and t1.shift = '{shift}' and t1.vehicle_id = '{vehicle_id}' and t1.ward_id = '{ward_id}' and t1.is_active = 't' and t2.is_active = 't' and t1.route_code = t2.route_code;"
            ...
            for row3 in fetch3:
                ...
                postgreSQL_select_Query4 = f"select bin_location,bin_code from swm.route_compliance where route_code = '{route_code}' and is_active = 't';"
...
def check_params(request, param):
    ...
    values = param
    return HttpResponse('Your parameter '+values +'is: {}'.format(param))
