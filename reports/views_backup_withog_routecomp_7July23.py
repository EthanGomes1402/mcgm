...
def get_vehicle_travel_history_2(request,param):
    ...
    q2 = "select bin_code,bin_location,bin_name from swm.route_compliance where is_active='t' and route_code_id='"+route_code_id+"' order by id asc"
    cursor.execute(q2)
...
def route_compliance(request):
    ...
    #print("Todate ", todate)    
        ...
        ward_id = str(fetch0[0])
        postgreSQL_select_Query1 = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name from swm.vehicles t1, swm.route_allocation t2, swm.route_compliance t3 where t1.ward_id = '{ward_id}' and t2.ward_id = '{ward_id}' and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' and t2.id = t3.route_code_id and t3.is_active = 't';"
        ...
        for row1 in fetch1:
            ...
            postgreSQL_select_Query3 = f"select bin_location,bin_name from swm.route_compliance where route_code_id = '{route_code_id}' and is_active = 't' order by id asc;"
...
def check_params(request, param):                #TEST FUNCTION
    ...
    #route_code_id = str(fetch_data[2])
    route_code_id = '144'
    q2 = "select bin_code,bin_location from swm.route_compliance where is_active='t' and route_code_id='"+route_code_id+"'"
    cursor.execute(q2)
    fetch_bin_data = cursor.fetchall()
...
def my_view(request):
    ...
    #print("Todate ", todate)    
        ...
        ward_id = str(fetch0[0])
        postgreSQL_select_Query1 = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name from swm.vehicles t1, swm.route_allocation t2, swm.route_compliance t3 where t1.ward_id = '{ward_id}' and t2.ward_id = '{ward_id}' and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' and t2.id = t3.route_code_id;"
        ...
        for row1 in fetch1:
            ...
            postgreSQL_select_Query3 = f"select bin_location,bin_name from swm.route_compliance where route_code_id = '{route_code_id}' and is_active = 't';"
...
def my_test_view(request):  
    ...
    #print("Todate ", todate)    
        ...
        if iward == 'ALL':
          ...
          postgreSQL_select_Query1_all_wards = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name,t4.name from swm.vehicles t1, swm.route_allocation t2,swm.route_compliance t3, common_ward t4 where t4.id = t1.ward_id and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' and t2.id = t3.route_code_id and t3.is_active = 't' order by t4.name asc;"  
          cursor.execute(postgreSQL_select_Query1_all_wards)
        else:  
          postgreSQL_select_Query1 = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name,t4.name from swm.vehicles t1, swm.route_allocation t2, swm.route_compliance t3, common_ward t4 where t4.name = '{iward}' and t1.ward_id = t4.id and t2.ward_id = t4.id and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' and t2.id = t3.route_code_id  and t2.route_code like '%WW' and t3.is_active = 't';"  
          cursor.execute(postgreSQL_select_Query1)
    ...
    if request.method == 'POST':
     #try:
        ...
        for ward_id1 in ward_fetch:
            ...
            postgreSQL_select_Query1 = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name from swm.vehicles t1, swm.route_allocation t2, swm.route_compliance t3 where t1.ward_id = '{ward_id}' and t2.ward_id = '{ward_id}' and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' and t2.id = t3.route_code_id and t3.is_active = 't'  and t2.route_code like '%WW';"
