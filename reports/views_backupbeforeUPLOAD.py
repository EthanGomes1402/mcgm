...
def get_vehicle_travel_history_2(request,param):
    ...
    return render(request,'reports/leaflet.html',{'response_data' : response_data['data']})
...
def route_compliance(request):
    ...
    #print("Todate ", todate)    
        ...
        for row1 in fetch1:
            ...
            postgreSQL_select_Query3 = f"select distinct t1.route_code,t1.route_name, t2.route_code_id from swm.route_allocation t1, swm.route_compliance t2 where t1.route_code <> '' and t1.shift = '{shift}' and t1.vehicle_id = '{vehicle_id}' and t1.ward_id = '{ward_id}' and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.route_code_id;"
...
def check_params(request, param):
    ...
    cursor = connection.cursor()
    val = (values[1])
    q1 = "select vehicle_id,shift,id from swm.route_allocation where route_code='"+val+"'"
    ...
    #return HttpResponse('Your parameter is  '+ str(fetch_data[0])+ ' '+ str(route_code_id))
