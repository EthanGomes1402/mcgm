...
def route_compliance(request):
    ...
    #print("Todate ", todate)    
        ...
        ward_id = str(fetch0[0])
        postgreSQL_select_Query1 = f"select distinct t1.id,t1.plate_number,t1.vehicle_type,t2.id,t2.route_code,t2.route_name from swm.vehicles t1, swm.route_allocation t2 where t1.ward_id = '{ward_id}' and t2.ward_id = '{ward_id}' and vehicle_type IN ('Refuse_Compactor','Refuse_Mini_Compactor') and t1.is_active = 't' and t2.is_active = 't' and t1.id = t2.vehicle_id and t2.shift = '{shift}' order by t1.id desc;"
        ...
        for row1 in fetch1:
            ...
            compliance_result_yes_no_website_array.append(compliance_result_yes_no_website_array_2[0])
