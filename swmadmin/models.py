...
class Route_schedule(models.Model):
    ...
    mlc         = models.ForeignKey(Stop_station,related_name='start',on_delete=models.CASCADE,null=True,limit_choices_to={'is_mlc': True} )
    chkpst      = models.ForeignKey(Stop_station,related_name='end',on_delete=models.CASCADE,null=True,limit_choices_to={'is_chkpst': True} )
